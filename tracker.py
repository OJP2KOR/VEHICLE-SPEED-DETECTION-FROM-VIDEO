...
class Track(object):
    ...
    def __init__(self, prediction, trackIdCount):
        ...
        self.KF = kalman_filter()  # KF instance to track this object
        self.prediction = np.asarray(prediction)  # predicted centroids (x,y)   https://docs.scipy.org/doc/numpy-1.15.0/reference/generated/numpy.asarray.html
